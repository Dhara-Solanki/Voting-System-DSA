...
int main()
{
    ...
    printf("\n\n 1.Register in voting system");
    printf("\n\n 2.Login in voting system");
    printf("\n\nEnter Your choice");
    scanf("%d",&opt);
    if(opt==1){
        system("clear");
        ...
        if(fwrite!=0){
            printf("\n\nYou are successfully registered in voting system");
        }
        else{
...
int *z;
 z = &UNIVERSAL;
     ...
     {
         if(
         (strcmp(temp->aadhar,"10001")==0&& strcmp(temp->name,"Rajat Kumar")==0 &&strcmp(temp->birth_date,"31-03-1999")==0) ||
